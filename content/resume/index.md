...
- **[Launched Android Auto with 75+ partners across 130+ head unit variants in the first 24 months.]({{< ref "work/android-auto-partner-engineering/index.md" >}})** Each one a distinct effort with a distinct partner---different hardware, different software stack, different OEM org. Joined as IC partner engineer on Google Maps automotive integrations and led the first two Android Auto OEM launches: [Hyundai (first to market)](https://www.hyundainews.com/assets/documents/original/23958-HYUNDAIISTHEFIRSTAUTOMAKERTOLAUNCHANDROIDAUTO.pdf) and Audi (fast-follow).
- **Scaled to 70M+ cars on the road---300+ car models from 40+ brands by 2017.** Got my team off the certification critical path: documented the integration protocol and testing procedures so OEM and supplier teams could validate their own work, then authorized 3rd Party Labs to certify head units without Google in the loop.
- **15-person global team across 5 countries, accountable for every OEM and Tier 1 integration worldwide.** Took global team leadership in 2015 and stood up engineering presence in Japan, South Korea, Germany, the UK, and the USA---co-located with the partner engineering teams across those time zones.
...
- **ByteByteGo**---[AI Engineering]({{< ref "/series/ai-engineering-course" >}})
